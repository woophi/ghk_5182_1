...
const sduiLink =
  'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/52458%3flocation=AM%26campaignCode=GH';
const sduiLink2 =
  'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/52459%3flocation=AM%26campaignCode=GH';
...
export const App = () => {
  ...
  const submitWith = () => {
    window.gtag('event', '5182_buy1_var1');
    setLoading(true);
    window.location.replace(sduiLink);
  };
  const submitWithout = () => {
    window.gtag('event', '5182_buy2_var1');
    setLoading(true);
